...
export function ProblemSolving5(_index) {
    return (
        <div>
            ...
            <FeedbackForm slide={5} part={"ps"} language={"DE"}></FeedbackForm>
        </div>
    );
}
...
export function ProblemSolving7(_index) {
    return (
        <div>
            ...
            <FeedbackForm slide={7} part={"ps"} language={"DE"}></FeedbackForm>
        </div>
    );
}
...
export function ProblemSolving12(_index) {
    return (
        <div>
            ...
            <FeedbackForm slide={12} part={"ps"} language={"DE"}></FeedbackForm>
...
export function ProblemSolving13(_index) {
    return (
        <div>
            ...
            <FeedbackForm slide={13} part={"ps"} language={"DE"}></FeedbackForm>
...
export function ProblemSolving16(_index) {
    return (
        <div>
            ...
            <FeedbackForm slide={16} part={"ps"} language={"DE"}></FeedbackForm>
